...
{
    internal class ClientTlsNetworkTransport : TlsNetworkTransport
    {
        ...
        public ClientTlsNetworkTransport(NetworkTransport transport, TlsOptions options, ILogger logger) : base(transport, options, logger)
        {
