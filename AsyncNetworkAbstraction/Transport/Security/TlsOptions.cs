...
namespace Orleans.Connections.Security
{
    ...
    public class TlsOptions
    {
        ...
        /// </para>
        /// </summary>
        public Func<NetworkTransport, string, X509Certificate2>? LocalServerCertificateSelector { get; set; }
        ...
        /// <summary>
        /// Specifies the client authentication certificate requirements for a TLS connection to Silo. Defaults to <see cref="Orleans.Connections.Security.RemoteCertificateMode.RequireCertificate"/>.
        /// </summary>
        ...
        /// </summary>
        public Action<NetworkTransport, TlsServerAuthenticationOptions>? OnAuthenticateAsServer { get; set; }

        /// <summary>
        /// Provides direct configuration of the <see cref="TlsClientAuthenticationOptions"/> on a per-connection basis.
        /// This is called after all of the other settings have already been applied.
        /// </summary>
        public Action<NetworkTransport, TlsClientAuthenticationOptions>? OnAuthenticateAsClient { get; set; }
